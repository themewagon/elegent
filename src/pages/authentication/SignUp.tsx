            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <FormControl variant="standard" fullWidth>
                        ...
                        <OutlinedInput placeholder="Enter your full name" id="name-input1" endAdornment={
                    ...
                    <FormControl variant="standard" fullWidth>
                        ...
                        <OutlinedInput placeholder="Enter your email" id="email-input1" endAdornment={
                            <InputAdornment position="end">
                    ...
                    <FormControl variant="standard" fullWidth>
                        ...
                        <OutlinedInput placeholder="Create password" type="password" id="password-input2" endAdornment={
                            <InputAdornment position="end">
